...
A cross-platform Flutter GUI for [proxy-everything](https://github.com/acking-you/proxy-everything).
...
- Flutter 3.38.6+
- Native libraries from [proxy-everything releases](https://github.com/acking-you/proxy-everything/releases)
...
gh workflow run build.yaml \
  -f lib_version=0.4.10 \
  -f create_release=true \
  -f release_tag=v1.1.0
```

Parameters:
- `lib_version`: Native library version from proxy-everything releases
- `create_release`: Whether to create GitHub release (default: true)
- `release_tag`: Release tag name (e.g., v1.1.0)
...
[proxy-everything](https://github.com/acking-you/proxy-everything) 的跨平台 Flutter 图形界面。
...
- Flutter 3.38.6+
- [proxy-everything releases](https://github.com/acking-you/proxy-everything/releases) 中的原生库
...
参数说明：
- `lib_version`：proxy-everything releases 中的原生库版本
- `create_release`：是否创建 GitHub release（默认：true）
- `release_tag`：发布标签名（如 v1.1.0）
